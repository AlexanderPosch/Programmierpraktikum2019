...
class StartScreen(tk.Frame):
    ...
    def draw(self,evnet=None):
        ...
        self.rb1 = tk.Radiobutton(self ,text="Beginner",variable=self.Mfsize , value=(5,5),font=("Courier", fontsize)) 
        self.rb2 = tk.Radiobutton(self ,text="Advanced",variable=self.Mfsize , value=(12,12),font=("Courier", fontsize)) 
        self.rb3 = tk.Radiobutton(self ,text="Expert  ",variable=self.Mfsize , value=(20,20),font=("Courier", fontsize)) 
...
class GameScreen(tk.Frame):
    def __init__(self, parent,owner):
        ...
        self.grid_rowconfigure(1, weight=1)
        self.grid_columnconfigure(0, weight=1)
        self.grid_rowconfigure(owner.Mfsize[0]+2, weight=1)
        self.grid_columnconfigure(owner.Mfsize[1]+2, weight=1)
        self.draw()
    ...
    def draw(self,event=None):
        ...
        for widget in self.winfo_children():
            widget.destroy()
        ###### Draw new  ########
        #self.Header=tk.Label(self,image=owner.headerim2)
...
class Pagemaneger(tk.Tk):
    ...
    def resizewindow(self,event):
        ...
        #self.after(100,self.frames[self.currentscreen].draw)
        
        self.after(1000,self.pass1)
        

    def pass1(self):
        self.counter+=1
        if (self.fw ,self.fh) ==(self.winfo_width(),self.winfo_height()):
            print(self.counter)
